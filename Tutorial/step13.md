...
同样，对于公开的，但不属于自己的文档，我们也需要构建单独的预览页面。其他人打开公开文档的链接时，可以看到一个简洁的预览页面。

当用户浏览自己的文档列表时，可以快速判断它们是公开的还是私密的。并且可以直接复制公开文档的分享链接发给其他人。

对于分析给特定用户组的文档，只有已登录且在这个组中的用户可以查阅。这是非常关键的企业文档分享能力。
